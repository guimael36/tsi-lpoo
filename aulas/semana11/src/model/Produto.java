...
public class Produto {
    ...
    public Produto(String sku1, String arroz, String descricao, int quantidade, BigDecimal precoDeCompra, BigDecimal precoDeVenda, List<Fornecedor> fornecedorList) {
    }
